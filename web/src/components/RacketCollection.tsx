          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
            ...
            {selectedProfessorId && selectedProfessorId !== 'all' && role !== 'PROFESSOR' && (
              <button 
                ...
                style={{ background: 'var(--primary-color)', color: '#1A112C', border: 'none', padding: '10px 16px', borderRadius: '8px', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
