    ...
    <div style={{
      ...
      <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }}
        ...
        <div style={{ background: '#FFFFFF', padding: '20px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #E5E7EB' }}>
          <div>
            <h3 style={{ color: '#1a1a2e', fontSize: '18px', fontWeight: 800, margin: 0, display: 'flex', alignItems: 'center', gap: '16px' }}>
              {activeTab === 'racket' ? (
                <>
                  <select 
        ...
        <div style={{ padding: '0', overflowY: 'auto', flex: 1, background: '#FFFFFF' }}>
          ...
          <div style={{ display: 'flex', gap: '32px', padding: '24px 32px', borderBottom: '1px solid #E5E7EB' }}>
            <div 
              ...
              style={{ fontSize: '18px', fontWeight: activeTab === 'racket' ? 800 : 700, color: activeTab === 'racket' ? '#1a1a2e' : '#60A5FA', cursor: 'pointer' }}
            >
              Encordoamentos da raquete
            </div>
            <div 
              onClick={() => setActiveTab('all')} 
              style={{ fontSize: '18px', fontWeight: activeTab === 'all' ? 800 : 700, color: activeTab === 'all' ? '#1a1a2e' : '#60A5FA', cursor: 'pointer' }}
            >
